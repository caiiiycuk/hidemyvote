...
//                                        (CvPoint*)cvGetSeqElem( result, i-1 )));
    ...
    Bitmap drawSquares(IplImage img, CvSeq squares) {
...
//             CV_READ_SEQ_ELEM(rect.position(3), reader);
    ...
    public Bitmap main(String filePathAndName) throws InterruptedException {
        ...
        img0 = cvLoadImage(filePathAndName, 0);
        if (img0 == null) {
            throw new IllegalArgumentException("Unable to read image: " + filePathAndName);
        }
        ...
        if (false) {
            ...
            bitmap = drawSquares(img, findSquares4(img, storage));
        } else {
//            IplImage gray = cvCreateImage(img.cvSize(), 8, 1);
//            IplImage binary = cvCreateImage(img.cvSize(), 8, 1);
//
//            cvCopy(img, gray);
...
//            cvReleaseImage(binary);
    ...
    public static void main(String[] args) {
        int i; // , c;
        String filePathAndName = "/Users/caiiiycuk/tmp/in.jpg";
        String out = "/Users/caiiiycuk/tmp/out.jpg";
        // create memory storage that will contain all the dynamic data
        ...
        // Java translation
        // img0 = cvLoadImage(names[i], 1);
        IplImage img0 = cvLoadImage(filePathAndName, 0);
        if (img0 == null) {
            throw new IllegalArgumentException("Unable to read image: " + filePathAndName);
        }
